...
bible.data = {
	...
	*/
	...
	"1Sam": {
		...
		"names":{"en":["1 Samuel","1S","1 Sam","1Sam","1 Sa","1Sa","I Samuel","I Sam","I Sa","IS"]}
	},
	"2Sam": {
	...
	"Zeph": {
		"chapters":[18,15,20],
		"names":{"en":["Zephaniah","Zp","Zep","Zeph","Ze"]}
	},
	"Hag": {
		"chapters":[15,23],
 ...
 */
bible.addNamesOld = function(lang, names) {
	for (var i in names) {
		bible.data[ bible.DEFAULT_BIBLE[i] ].names[lang] = names[i];
	}
}
bible.addNames = function(lang, bookList, namesData) {
	for (var i in bookList) {
		...
		if (typeof names === 'string')
			bible.data[ osisKey ].names[lang] = [names];
		else
			bible.data[ osisKey ].names[lang] = names;
...
// Greek
bible.addNames("el", bible.NT_BOOKS, [
...
// Hebrew
bible.addNames("il", bible.OT_BOOKS, [

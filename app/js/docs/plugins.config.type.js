...
docs.plugins.push({
	...
	init: function(docManager) {
		...
		docManager.createFontSlider = function(title, prefix) {
			...
			var configBlock =
				$('<div class="config-options" id="config-' + prefix + '"><h3 id="config-size-title">' + title + ': <span id="font-size"></span></h3></div>')
			...
			configBlock.append($('<div id="font-slider"></div><br><h3>Elements</h3>'));
        ...
        update: function() {
          ...
          if (slider.pagingCount === 1) {
            ...
            if (slider.animatingTo === 0) {
              slider.directionNav.removeClass(disabledClass).filter('.' + namespace + "prev").addClass('pull-prev');
            } else if (slider.animatingTo === slider.last) {
              slider.directionNav.removeClass(disabledClass).filter('.' + namespace + "next").addClass('pull-next');
            } else {
